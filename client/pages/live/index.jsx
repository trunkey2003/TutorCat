  ...
  const handleAddProgrammingLanguage = (language) => {
    if (programmingLanguages.includes(language)) {
      setProgrammingLanguages(
        programmingLanguages.filter((e) => e != language)
      );
      return;
    }
  ...
  if (error == "503")
    return (
      <div className="w-full h-screen bg-black bg-opacity-70 flex justify-center items-center text-white text-[40px]">
        <div>
          <div className="text-[80px] font-bold text-center text-red-300">
            503
          </div>
  ...
  return (
    <AuthLayout>
      <div className="bg-sky-100">
        <div className="bg-sky-200 md:mx-[8%] p-5">
          <div className="flex flex-wrap justify-center relative">
            <div className="bg-sky-500 w-60 h-72 m-8 rounded-lg ">
              <div className="bg-white w-60 h-72 m-0 hover:-m-2 absolute rounded-lg shadow-lg hover:shadow-2xl transition-all duration-150 ease-in hover:ease-out ">
                ...
                <p className="m-4 text-sm">
                  You can call privately, and other people won{`'`}t see your
                  identity. But your activity might still be visible to us.
                </p>
              </div>
            </div>
            <div className="bg-sky-500 w-60 h-72 m-8 rounded-lg ">
              <div className="bg-white w-60 h-72 m-0 hover:-m-2 absolute rounded-lg shadow-lg hover:shadow-2xl transition-all duration-150 ease-out hover:ease-in ">
                <h1 className="m-4 text-2xl font-bold flex items-center">
                  Easy
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <hr className="m-4 rounded-2xl border-t-2" />
                <p className="m-4 text-sm">
                  We don{`'`}t require an account to use LiveTutor platform.
                </p>
              </div>
            </div>
            <div className="bg-sky-500 w-60 h-72 m-8 rounded-lg ">
              <div className="bg-white w-60 h-72 m-0 hover:-m-2 absolute rounded-lg shadow-lg hover:shadow-2xl transition-all duration-150 ease-in hover:ease-out ">
                ...
                <hr className="m-4 rounded-2xl border-t-2" />
                <p className="m-4 text-sm">
                  We don{`'`}t record your video for any purpose, and your
                  history calls will just only visible to you.
                </p>
              </div>
            </div>
            <div className="bg-sky-500 w-60 h-72 m-8 rounded-lg ">
              <div className="bg-white w-60 h-72 m-0 hover:-m-2 absolute rounded-lg shadow-lg hover:shadow-2xl transition-all duration-150 ease-in hover:ease-out ">
                ...
                <hr className="m-4 rounded-2xl border-t-2" />
                <p className="m-4 text-sm">
                  This platform is totally free for everyone.
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            className="flex relative mt-5 w-[180px] mx-auto bg-sky-600 rounded hover:cursor-pointer hover:bg-sky-700"
          >
        ...
        <div className="flex justify-center">
          ...
          <div className="flex flex-wrap bg-white min-h-screen rounded p-10 md:p-16">
            {rooms.length
              ? rooms.map((room) => (
                  <div
                  ...
                  >
                    ...
                    <div
                      id="userCount"
                      className="py-2 flex font-medium text-sm"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 512"
                    ...
                    <div id="programmingLanguages" className="flex py-2">
                      {room.programmingLanguages &&
                      room.programmingLanguages.length
                        ? room.programmingLanguages.map(
              ...
              <div className="font-tapestry p-4">
                ...
                <div className="w-full max-w-sm mx-auto">
                  ...
                  <p className="text-gray-600 text-[12px] italic">
                    This helps people know how to call you, you can let this
                    field empty
                  </p>
                </div>
              </div>
