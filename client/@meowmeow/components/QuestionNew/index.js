...
class MyComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = { title: '', editorHtml: '', tags: null, openModal: false, modalType: null, modalContent: '', questionId: null, redirectTo: '' };
    ...
    handleSend = () => {
        ...
        httpClient
            ...
            .then(data => {
                this.setState({ questionId: data.data })
            })
    }
    ...
    handleSubmit = () => {
        ...
        httpClient
            ...
            .then(({ data }) => {
                let res = data.data
                let content = (res !== null) ? <IntlMessages id="questions.add.success" /> : <IntlMessages id="questions.add.failed" />
                this.setState({ openModal: true, modalType: (res !== null) ? "redirect" : null, modalContent: content, questionId: res })
            })
            .catch(()=>{
               let res = null
                let content = (res !== null) ? <IntlMessages id="questions.add.success" /> : <IntlMessages id="questions.add.failed" />
