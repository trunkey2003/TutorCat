...
export default function LanguageSwitcher() {
    ...
    return (
        <div className="dropdown mr-2">
            <label tabIndex="0" className="btn btn-sm btn-ghost btn-no-uppercase">
                <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
                ...
                <IntlMessages id="navmenu.language.current" />
            </label>
            <ul tabIndex="0" className="dropdown-content menu p-2 shadow bg-white w-40 drop-shadow mt-1">
                <li><a 
                    onClick={() => dispatch(setVi())}
                    className={
                        (langCode == 2) ? "active" : ""
                    }>
                    <IntlMessages id="navmenu.language.vietnamese" />
                </a></li>
                <li><a 
                    onClick={() => dispatch(setEng())}
                    className={
                        (langCode == 1) ? "active" : ""
                    }>
                    <IntlMessages id="navmenu.language.english" />
                </a></li>
            </ul>
        </div>
    );
